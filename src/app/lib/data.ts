...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'threaded-rod-ss',
    name: 'THREADED ROD STAINLESS STEEL',
    description: 'High-quality marine grade stainless steel threaded rod for corrosive environments.',
    category: 'threaded-rod',
    material: 'Stainless Steel',
    finish: 'Natural',
    headStyle: 'Threaded Rod',
    driveType: 'N/A',
    price: 4.50,
    image: 'https://i.ibb.co/qYx5bQJz/THREADED-ROD-STAINLESS-STEEL.png',
    stockStatus: 'In Stock',
    sizes: ['M5', 'M6', 'M8', 'M10', 'M12', 'M16', 'M20', 'M24'],
    specs: { length: '1 Meter', diameter: 'M5-M24', threadType: 'Metric' }
  },
  {
    id: 'threaded-rod-zp',
    name: 'THREADED ROD ZINC PLATED',
    description: 'General purpose zinc-plated threaded rod, available in 1m and 3m lengths.',
    category: 'threaded-rod',
    material: 'Steel',
    finish: 'Zinc Plated',
    headStyle: 'Threaded Rod',
    driveType: 'N/A',
    price: 2.25,
    image: 'https://i.ibb.co/CKcd5sKW/THREADED-ROD-ZINC-PLATED.png',
    stockStatus: 'In Stock',
    variants: [
      {
        type: '1 meter',
        options: ['M5', 'M6', 'M8', 'M10', 'M12', 'M16', 'M20']
      },
      {
        type: '3 meter',
        options: ['M6', 'M8', 'M10', 'M12']
      }
    ],
