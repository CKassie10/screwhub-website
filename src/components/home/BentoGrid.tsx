    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-auto lg:h-[800px]">
          ...
          >
            <Image src={CATEGORIES[0].image} alt={CATEGORIES[0].name} fill className="object-cover grayscale group-hover:grayscale-0 transition-all duration-700" />
            ...
            <div className="absolute bottom-10 left-10 p-2">
              ...
              <h3 className="text-4xl font-headline font-bold text-white mb-4 leading-none">{CATEGORIES[0].name}</h3>
              <Link href={`/shop?category=${CATEGORIES[0].id}`} className="inline-flex items-center gap-2 text-white/60 hover:text-white transition-colors group/link">
          ...
          >
             <Image src={CATEGORIES[1].image} alt={CATEGORIES[1].name} fill className="object-cover opacity-60 group-hover:scale-110 transition-transform duration-700" />
             <div className="absolute inset-0 bg-primary/40 group-hover:bg-primary/20 transition-all" />
             <div className="absolute inset-0 p-8 flex flex-col justify-end">
                <h3 className="text-xl font-headline font-bold text-white">{CATEGORIES[1].name}</h3>
          ...
          >
             <Image src={CATEGORIES[2].image} alt={CATEGORIES[2].name} fill className="object-cover opacity-60 group-hover:scale-110 transition-transform duration-700" />
             <div className="absolute inset-0 p-8 flex flex-col justify-end">
                <h3 className="text-xl font-headline font-bold text-white">{CATEGORIES[2].name}</h3>
                <Link href="/shop" className="text-white/60 text-xs mt-2 flex items-center gap-1">View Collection <ArrowUpRight className="h-3 w-3" /></Link>
             </div>
          </motion.div>
          ...
          >
             <div className="absolute inset-0 flex items-center justify-around px-8">
               <div className="max-w-[50%]">
                 <h3 className="text-2xl font-headline font-bold text-primary leading-tight">Stainless Series A4 Marine</h3>
               ...
               <div className="relative w-40 h-40 group-hover:rotate-[30deg] transition-transform duration-1000">
                  <Image src={CATEGORIES[3].image} alt="Stainless" fill className="object-contain" />
               </div>
             </div>
          </motion.div>
        </div>
